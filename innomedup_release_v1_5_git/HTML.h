...
"<p>"
"<label>binID:&nbsp;</label>""<input maxlength=\"30\" name=\"binID\"><br>"
"<label>SSID:&nbsp;</label>"
"<input maxlength=\"30\" name=\"ssid\"><br>"
"<label>Key:&nbsp;&nbsp;&nbsp;&nbsp;</label><input maxlength=\"30\" name=\"password\"><br>"
"<label>Check Interval (mins):</label><input maxlength=\"30\" name=\"checkInterval\" value=\"1\"><br>"
"<label>Status Interval (mins):</label><input maxlength=\"30\" name=\"statusInterval\" value=\"10\"><br>"
...
"<label>PowerSaving(0 or 1):</label><input maxlength=\"30\" name=\"powerSaving\" value=\"0\"><br>"
"<label>DisplayClock(0 or 1):</label><input maxlength=\"30\" name=\"displayClock\" value=\"1\"><br>"
