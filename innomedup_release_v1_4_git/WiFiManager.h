 ...
 */
bool writeToMemory(String ssid, String pass,int checkInterval,int statusInterval,int gmt,int debug, int sleepOnLowBattery, int powerSaving, int weightThreshold){
  char buff1[30];
  char buff2[30];
  //int interval;
